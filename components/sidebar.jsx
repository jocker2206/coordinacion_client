...
import { coordinacion } from '../services/urls';
...
class Sidebar extends Component {
  ...
  getProfile =  async () => {
    axios.get(`${coordinacion}/profile`, { headers: { Authorization: await Bearer() } })
    .then(res => {
              ...
              <nav id="stacked-menu" className="stacked-menu">
                <ul className="menu">
                  <li className="menu-item has-active">
                    <a href="/" className="menu-link text-success">
                      <span className="menu-icon text-success fas fa-user"></span>{" "}
